 ...
 */
public final class MetricsCollectorInterceptor implements EventInterceptor, EventBusMetrics {
     ...
     */
    public MetricsCollectorInterceptor(EventBus bus, ListenerRegistry registry) {
