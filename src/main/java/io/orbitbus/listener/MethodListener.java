 ...
 */
public final class MethodListener<T extends Event> implements EventListener<T> {

    private final Object target;
    private final Method method;

    public MethodListener(Object target, Method method) {
        this.target = target;
        this.method = method;
        method.setAccessible(true);  // Allow access to private/package-private/local classes
    }
