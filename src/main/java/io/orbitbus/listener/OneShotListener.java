 ...
 */
public final class OneShotListener<T extends Event> implements EventListener<T> {
    ...
    public OneShotListener(Class<T> eventType, EventListener<T> delegate, EventBus bus) {
