...
class OrbitEventBusAnnotationTest {
    ...
    static class MultiEventHandler {
        private final List<String> sink;
    ...
    static class HighPriorityHandler {
        private final List<String> sink;
    ...
    static class LowPriorityHandler {
        private final List<String> sink;
    ...
    static class NonEventParamHandler {
        @Subscribe
