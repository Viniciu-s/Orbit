...
echo ""
echo "2. Push do commit e tag:"
echo "   ${GREEN}git push origin $(git branch --show-current)${NC}"
echo "   ${GREEN}git push origin v$NEW_VERSION${NC}"
echo ""
warning "Importante: o workflow Release - Maven Central só roda quando a tag é enviada ao GitHub."
warning "Criar PR/merge do commit não envia a tag local; após o merge, envie a tag com:"
